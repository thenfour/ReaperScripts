...
the LOWEST note of the chord starting at the edit cursor will be transposed an octave HIGHER.
basically inverting the chord UPWARDS.
...
DBG("}")
reaper.Undo_EndBlock("tenfour - Rotate voicing up at edit cursor", -1)
